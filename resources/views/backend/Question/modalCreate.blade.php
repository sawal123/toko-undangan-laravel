        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h5>Input Data Testimonial</h5>
                        <form action="{{ url('dashboard/add-testimonial') }}" method="POST" id="form-validation-2"
                            ...
                            <div class="mb-2 col">
                                ...
                                <input class="form-control" type="text" name="nama" placeholder="Enter Nama">
