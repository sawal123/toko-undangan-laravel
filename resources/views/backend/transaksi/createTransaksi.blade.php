                    ...
                    <div class="page-title-box d-flex justify-content-between">
                        ...
                        <div class="float-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ url('/dashboard/transaksi') }}">Transaksi</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-3 needs-validation" novalidate>
                                <div class="col-md-4">
                                    <label for="id="default" class="form-label">State</label>
                                    <select class="form-select" id="default" required>
                                      <option selected disabled value="">Choose...</option>
                                      @foreach ($costumer as $cos)
                                      <option value="{{$cos->uuid}}">{{$cos->name}}</option>
                                      @endforeach
                                    </select>
