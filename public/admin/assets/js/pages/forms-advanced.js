...
var hueb = new Huebee(".color-input", { setBGColor: !0, saturations: 3 }),
    ...
    startPhoneMask = IMask(document.getElementById("start-phone-mask"), {
        ...
        .on("accept", function () {
            (document.getElementById("start-phone-complete").style.display =
                ""),
                (document.getElementById("start-phone-unmasked").innerHTML =
                    startPhoneMask.unmaskedValue);
        })
    ...
    momentMask = IMask(document.getElementById("moment-mask"), {
        ...
        document.getElementById("moment-value").innerHTML =
            momentMask.masked.date || "-";
    });
